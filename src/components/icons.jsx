      ...
      <Zoom top>
        ...
        <div className="axios effect">
          <a
            ...
            rel="noopener noreferrer"
          >
            <img src={require("../images/axios.svg").default} alt="axios" />
          </a>
          <p>Axios</p>
        </div>
        <div className="sqlite effect">
          ...
          >
            <img
              src={require("../images/SQLite-logo.png").default}
              alt="sqlite"
            />
          </a>
          <p>SQlite</p>
        ...
        <div className="expressjs effect">
          ...
          >
            <img
              src={require("../images/expressjs.png").default}
              alt="expressjs"
            />
          </a>
          <p>Express.js</p>
        ...
        <div className="postman effect">
          ...
          >
            <img
              src={require("../images/postman-logo.png").default}
              alt="postman"
            />
          </a>
          <p>Postman</p>
        ...
        <div className="python effect">
          ...
          >
            <img
              src={require("../images/python-logo.png").default}
              alt="python"
            />
          </a>
          <p>Python</p>
